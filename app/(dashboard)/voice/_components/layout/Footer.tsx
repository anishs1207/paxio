...
const ChatFooter: React.FC<ChatFooterProps> = ({
    ...
    return (
        <footer
            className={`mb-3 w-full p z-50 flex justify-center 
      ...
      transition-all duration-500 ${appState !== "idle"
        ...
        >
            <div className="w-full  max-w-3xl flex flex-col gap-6">
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 mt-4 mb-4">
                    <AnimatePresence mode="wait">
                        {isKeyboardVisible ? (
                            <div className="flex mt-0 items-center gap-1 w-full pl-3 pr-3">
                                {/* <Image
                                    src={personal}
    ...
    /> */}
                                ...
                                <motion.form
                                    ...
                                    className=" flex-1 flex items-end gap-4 bg-zinc-900/30 border border-zinc-800/50 p-3 pl-8 md:p-5 md:pl-10 rounded-[2rem] backdrop-blur-3xl shadow-2xl focus-within:border-zinc-700 transition-all"
                                >
                                    ...
                                    <textarea
                                        ...
                                        className="flex-1 bg-transparent border-none outline-none text-zinc-100 placeholder:text-zinc-700 text-lg md:text-xl font-light py-2 md:py-3 resize-none overflow-y-auto max-h-[200px] scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent"
                                    />
                            ...
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="flex-1 flex items-center justify-center gap-10 md:mt-8"
                            >
                                <button
