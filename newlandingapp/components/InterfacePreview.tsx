        ...
        <div className="rounded-[2rem] bg-black border border-[#222] overflow-hidden relative h-[400px] md:h-[600px] flex items-center justify-center">
          ...
          <div className="relative z-10 bg-black/60 backdrop-blur-xl border border-white/10 p-8 rounded-3xl max-w-md w-full mx-4 shadow-2xl animate-[float_8s_ease-in-out_infinite_1s]">
            ...
            <div className="flex gap-3">
              <button className="flex-1 bg-white text-black text-xs font-bold py-3 rounded-xl hover:bg-gray-200 transition active:scale-95 duration-150">
                Execute
              </button>
              <button className="flex-1 bg-[#1a1a1a] text-white text-xs font-bold py-3 rounded-xl border border-white/5 hover:bg-[#2a2a2a] transition active:scale-95 duration-150">
                Refine
              </button>
            </div>
          </div>
